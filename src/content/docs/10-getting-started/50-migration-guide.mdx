...
|------------|---------------|
| `"@ngx-translate/core": "^17` | Pre-flight: Angular peer dep is now `>=18`. See [Angular 16 → 18 peer dependency bump](#angular-16--18-peer-dependency-bump--impact-high-pre-flight). |
...
|------------------|-----|
| `npm ERR! ERESOLVE could not resolve` … `peer @angular/core@">=18"` | Upgrade Angular first. See [Angular 16 → 18 peer dependency bump](#angular-16--18-peer-dependency-bump--impact-high-pre-flight). |
...
v18 raises the minimum Angular peer dependency from `^16.0.0` to `>=18`
