...
|------------|---------------|
| `npm install @ngx-translate/core` (on Angular 16/17) | Pre-flight: Angular peer dep is now `^18.0.0`. See [Angular 16 → 18 peer dependency bump](#angular-16--18-peer-dependency-bump--impact-high-pre-flight). |
