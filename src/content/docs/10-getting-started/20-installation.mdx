...
In your components, you'll need to import `TranslatePipe` and `TranslateDirective` to your `imports`
(v18 also ships [`TranslateBlockDirective`](/getting-started/translating-your-components/#translateblock-structural-directive)
