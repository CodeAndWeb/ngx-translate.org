...
see the [Angular Compatibility](/getting-started/angular-compatibility/) documentation.
...
ngx-translate works with Angular's modern standalone components. If you're using NgModules, see the [NgModules Support](/reference/ngmodules/) documentation.
