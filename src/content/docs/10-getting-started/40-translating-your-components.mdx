...
Using translations in your templates is straightforward. You just need to make sure that the
`TranslatePipe` and `TranslateDirective` are available in your component.
