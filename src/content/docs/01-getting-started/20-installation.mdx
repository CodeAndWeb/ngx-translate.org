...
<CardGrid>
    <LinkCard title="Standalone Components"
              href="#using-standalone-components"
              description="You application has a file app.config.ts in src/app. Your components set the property 'standalone:true.'"
    />
    <LinkCard title="NgModule"
              href="#using-ngmodule"
              description="You application has a file app.module.ts in src/app. Your components have no 'standalone' property."
    />
</CardGrid>
...
<LinkCard title="Loading translation files" href="/getting-started/loading-translation-files" />
