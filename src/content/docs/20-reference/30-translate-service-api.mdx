...
To use the TranslateService in your components, inject it using Angular's `inject()` function:
...
The following methods are deprecated and should be replaced with their modern equivalents.
...
We've deprecated the use of these properties because they duplicate functionality that is also
available as methods.

| Property                                     | Description                                               |
|---------------------------------------------------------|-----------------------------------------------------------|
| `langs`                                   | List of languages. Use `getLangs()` instead.      <br /> `readonly string[]`                         |
| `currentLang`                                   | The language currently in use. Access the current language through this property.     <br /> `string`                         |
| `defaultLang`                               | The fallback language. Use `getFallbackLang()` instead.   <br /> `string | null`                           |
| `onDefaultLangChange`  | Observable that emits when the fallback language changes. Use `onFallbackLangChange` instead. <br /> `Observable<DefaultLangChangeEvent>`|
