...
- **Upgrade**
Upgrade to the current version of Ngx-translate. We have worked hard to make upgrading simple. You can view our [migration guide](/v16/getting-started/migration-guide/) to assist you in your upgrade.
