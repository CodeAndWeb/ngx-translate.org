...
description: Official documentation for @ngx-translate/core — the powerful
  translation and internationalization (i18n) library for Angular.
head:
  - tag: meta
    attrs:
      property: og:image
...
![ngx-translate i18n library for Angular](/images/v17/opengraph.jpg)
