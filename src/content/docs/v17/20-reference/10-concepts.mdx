...
* [**TranslateService**](/v17/reference/translate-service-api/)
...
* [**provideTranslateService**](/v17/reference/configuration/#providetranslateserviceconfig-roottranslateserviceconfig)
...
* [**provideChildTranslateService**](/v17/reference/configuration/#providechildtranslateserviceconfig-childtranslateserviceconfig)
...
For applications using NgModules, see the [NgModules Support](/v17/reference/ngmodules/) documentation for configuration with **TranslateModule**.

## Provider Functions

NGX-Translate v17 uses a modern provider function pattern that replaces the traditional Angular provider syntax. For detailed configuration options, see the [Provider Functions section in Configuration](/v17/reference/configuration/#provider-functions).
...
* [**TranslateLoader**](/v17/reference/translate-loader-api/)
...
* [**MissingTranslationHandler**](/v17/reference/missing-translation-handler-api/)
...
* [**TranslateCompiler**](/v17/reference/translate-compiler-api/)
...
* [**TranslateParser**](/v17/reference/translate-parser-api/)
