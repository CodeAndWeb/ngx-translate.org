...
slug: v17/reference/translate-compiler-api
---

After a translation file is loaded using the [`TranslateLoader`](/v17/reference/translate-loader-api/), it is passed
...
When translating a single message, the [`TranslateParser`](/v17/reference/translate-parser-api/) uses the
...
For detailed examples and step-by-step instructions on building and registering custom compilers, see [Custom Translation Compilers](/v17/recipes/custom-compiler-guide/).
