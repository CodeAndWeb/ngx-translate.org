...
slug: v17/reference/missing-translation-handler-api
---
...
* If it returns an observable, the value returned by this observable will be used (except if the translation
  was done using [`instant()`](/v17/reference/translate-service-api/#instant)).
* If the result is `undefined` the key will be used as a value

## How to Build a Custom Handler

For detailed examples and step-by-step instructions on building and registering custom missing translation handlers, see [How to handle missing translations](/v17/recipes/handle-missing-translations/).
