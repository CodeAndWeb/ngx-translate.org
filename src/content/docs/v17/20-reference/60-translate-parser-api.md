...
slug: v17/reference/translate-parser-api
---
...
If you are not using a [compiler](/v17/reference/translate-compiler-api/), you can expect `expr` to be a `string`.
...
For a complete example of how to build and register a custom parser, see the [Write Your Own Parser](/v17/recipes/write-own-parser/) recipe.
