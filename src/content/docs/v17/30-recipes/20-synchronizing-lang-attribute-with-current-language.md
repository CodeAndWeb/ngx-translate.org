...
description: Learn how to automatically synchronize the HTML lang attribute with
  ngx-translate language changes for better SEO and accessibility
slug: v17/recipes/synchronize-lang-attribute-with-current-language
---
