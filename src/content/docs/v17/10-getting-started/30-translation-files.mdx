...
slug: v17/getting-started/translation-files
---
...
The easiest way to set translation data is by using `import` and [`setTranslation()`](/v17/reference/translate-service-api/#settranslation).
...
by implementing your own [loader](/v17/reference/translate-loader-api/) or using one of the
[plugins](/v17/resources/plugins/).
