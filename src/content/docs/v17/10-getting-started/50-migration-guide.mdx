...
slug: v17/getting-started/migration-guide
---
...
[Angular Compatibility](/v17/getting-started/angular-compatibility/) documentation.
...
For comprehensive information about using ngx-translate with NgModules, see the [NgModules Support](/v17/reference/ngmodules/) documentation.
...
| `getParsedResult` | - | Signature changed. This method is not part of the official interface - it has to be public to be available from the directive and pipe. |
...
## 5. Renamed internal classes

We renamed some internal classes to make their names more consistent with the rest of the library.

| v16 Class | v17 Class | Notes |
|------------|------------|-------|
