...
description: Complete guide on using ngx-translate in Angular components. Learn
  TranslatePipe, TranslateDirective, and programmatic translation methods with
  code examples.
slug: v17/getting-started/translating-your-components
---
...
<Aside type="caution" title="Watch out!">
  ...
  * NG8004: No pipe found with name 'translate'.
  ...
  For NgModule-based applications, see the [NgModules Support](/v17/reference/ngmodules/) documentation.
</Aside>
...
To use translations in your code, you can access the [TranslateService](/v17/reference/translate-service-api/)
...
You might wonder why the [`get()`](/v17/reference/translate-service-api/#get) method
...
Alternatively, you can use [`stream()`](/v17/reference/translate-service-api/#stream),
...
use [`instant()`](/v17/reference/translate-service-api/#instant). This method returns
...
[`setTranslation()`](/v17/reference/translate-service-api/#settranslation).
