...
description: Learn how to install and configure ngx-translate in your Angular
  project. Complete setup guide with code examples for Angular translation and
  internationalization.
slug: v17/getting-started/installation
---
...
you can check out the [Angular Compatibility](/v17/getting-started/angular-compatibility/) documentation.
...
ngx-translate works great with Angular's modern standalone components for building multilingual applications. If you're using NgModules, you can check out the [NgModules Support](/v17/reference/ngmodules/) documentation.

:::note
For comprehensive information about using ngx-translate with NgModules, you can refer to the [NgModules Support](/v17/reference/ngmodules/) documentation.
:::
