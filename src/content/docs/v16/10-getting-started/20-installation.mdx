...
slug: v16/getting-started/installation
---

import {Tabs, TabItem, CardGrid, LinkCard} from "@astrojs/starlight/components";
import { PackageManagers } from 'starlight-package-managers'

:::danger[This version of ngx-translate is not supported anymore]

When using an EOL (End Of Lifetime) version, you have a few options:

- **Upgrade**
Upgrade to the current version of Ngx-translate. We have worked hard to make upgrading simple. You can view our [migration guide](/getting-started/migration-guide/) to assist you in your upgrade.

- **Remain Out of Date**
Continue using the outdated version, but be aware that you will be subject to security risks and bugs.
...
| 16 - 19+ | 16.x | 16.x | [Tutorial](https://www.codeandweb.com/babeledit/tutorials/how-to-translate-your-angular-app-with-ngx-translate/) |
| 16 - 17+ | 16.x ([15.x](/v15/)) | 16.x, (8.x) | [Tutorial](https://www.codeandweb.com/babeledit/tutorials/how-to-translate-your-angular-app-with-ngx-translate/) |
...
See the section [Translate Module API](/v16/reference/configuration/) for details.
...
[`setDefaultLang()`](/v16/reference/translate-service-api/#setdefaultlang) sets the default language. The default language is used
...
[`use()`](/v16/reference/translate-service-api/#use) sets the current language for the application. If the selected language is not yet
