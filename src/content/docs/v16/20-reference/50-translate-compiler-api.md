...
slug: v16/reference/translate-compiler-api
---

## TranslateCompiler API

After a translation file is loaded using the [`TranslateLoader`](/v16/reference/translate-loader-api/), it is passed
...
To make use of a `TranslateCompiler`, pass it with the configuration of the  [`TranslateModule`](/v16/reference/configuration/).
...
When translating a single message, the [`TranslateParser`](/v16/reference/translate-parser-api/) uses the
