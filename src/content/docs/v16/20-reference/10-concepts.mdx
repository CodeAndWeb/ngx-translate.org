...
* [**TranslateModule**](/v16/reference/configuration/)
  ...
  implementation. Not required for standalone components.

* [**TranslateService**](/v16/reference/translate-service-api/)
...
* [**TranslateLoader**](/v16/reference/translate-loader-api/)
...
* [**MissingTranslationHandler**](/v16/reference/missing-translation-handler-api/)
...
* [**TranslateCompiler**](/v16/reference/translate-compiler-api/)
...
* [**TranslateParser**](/v16/reference/translate-parser-api/)
