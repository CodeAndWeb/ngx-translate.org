...
slug: v16/recipes/handle-missing-translations
---

You can set up a provider for the [`MissingTranslationHandler`](/v16/reference/missing-translation-handler-api) in the
...
You can use [`useDefaultLang`](/v16/reference/configuration) to decide whether default language string
