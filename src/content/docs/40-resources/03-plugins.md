...
* [ngx-translate-multi-http-loader](https://github.com/denniske/ngx-translate-multi-http-loader) by @denniske: Fetch multiple translation files with ngx-translate. _(Superseded in v18 by built-in multi-resource support — see [Loading multiple resources](/getting-started/translation-files/#loading-multiple-resources). Still works under v18 for users not ready to migrate.)_
